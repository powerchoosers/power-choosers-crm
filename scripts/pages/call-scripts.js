(function(){
  ...
  const FLOW = {
    ...
    gatekeeper_intro: {
      stage: 'Gatekeeper',
      text: "<span class=\"tone-marker friendly\">friendly, confident tone</span> {{day.part}}, this is (your name) from Power Choosers. <span class=\"pause-indicator\"></span> Quick question — how does your company typically handle energy contract renewals? <span class=\"pause-indicator\"></span> Is that something [CFO/Operations Manager] handles?",
      responses: [
