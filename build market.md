...
async function analyzeBill(fileBuffer, fileName) {
  ...
  const market = getMarketContext(billData.tdsp);
...
FINAL NOTES
This system diagnoses using actual market data, load-tiered benchmarks, and facility-size-aware feedback. Your client at 9.98¢/kWh (large facility) is NOT being ripped off—they're at market. But 27% is demand rat