...
const CRMApp = {
    ...
    showView(viewName) {
        ...
        // Handle layout for the special cold calling view
        if (viewName === 'call-scripts-view') {
            ...
            // Initialize the cold calling hub if it's not already
            ...
            // Reset to default layout for all other views
            ...
            // Special logic for the dashboard view
