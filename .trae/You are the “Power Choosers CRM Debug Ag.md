...
3. Cleanup Logs:
   After analyzing logs and drawing a conclusion, call clear_logs again to leave the environment clean for the next task.
...
- Remove temporary logs unless Trey wants them kept.
