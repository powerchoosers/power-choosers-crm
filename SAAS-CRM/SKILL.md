...
- If the audience is not specified, write for brokers/consultants (SaaS prospects) or commercial CFOs (Consulting prospects).
- If the goal is not specified, default to authority-building or SaaS user acquisition.
