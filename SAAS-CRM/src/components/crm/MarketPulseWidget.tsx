...
export default function MarketPulseWidget() {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="px-3 !pt-[3px] !pb-[12px] rounded-2xl nodal-module-glass nodal-monolith-edge space-y-0.5">
      ...
      <div className="p-4 rounded-2xl nodal-module-glass nodal-monolith-edge space-y-3 relative overflow-hidden">
