...
export default function OperationalButton({ icon: Icon, label, onClick }: OperationalButtonProps) {
  return (
    <button 
      onClick={onClick}
      className="flex flex-col items-center justify-center p-4 rounded-2xl bg-black/40 nodal-monolith-edge hover:bg-black/60 transition-all group w-full hover:shadow-[0_0_30px_-5px_rgba(0,47,167,0.2)]"
      title={label}
    >
