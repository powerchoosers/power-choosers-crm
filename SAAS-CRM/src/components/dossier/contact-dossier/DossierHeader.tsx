...
import {
    ArrowLeft, Globe, Linkedin, Lock, Unlock, Clock, Activity, Check, MapPin, Trash2
} from 'lucide-react'
                                ...
                                {isEditing ? (
                                    <div className="flex items-center gap-2">
                                        <input
                                            ...
                                            className="text-2xl font-semibold tracking-tighter text-white bg-transparent border-none outline-none focus:ring-1 focus:ring-[#002FA7]/50 rounded px-1 -ml-1 w-36"
                                            placeholder="First"
                                            autoFocus
                                        />
                                        <input
                                            ...
                                            onKeyDown={(e) => e.key === 'Enter' && toggleEditing()}
                                            className="text-2xl font-semibold tracking-tighter text-white bg-transparent border-none outline-none focus:ring-1 focus:ring-[#002FA7]/50 rounded px-1 w-40"
                                            placeholder="Last"
                                        />
                                    </div>
                                ) : (
                                    ...
                                    <div className="flex items-center gap-3 w-full">
                                        <div className="flex items-center gap-1.5">
                                            <input
                                                ...
                                                onKeyDown={(e) => e.key === 'Enter' && toggleEditing()}
                                                className="bg-transparent border-b border-white/10 text-white text-xs font-mono uppercase tracking-widest w-32 focus:outline-none focus:border-[#002FA7] transition-colors placeholder:text-zinc-700"
                                                placeholder="TITLE"
                                            />
                                            <span className="text-zinc-600 lowercase shrink-0">at</span>
                                            <input
                                                type="text"
                                                value={editCompany}
                ...
                <div className="flex-none shrink-0 text-right">
                    <div className="flex flex-col items-end gap-0.5">
                        <div className="flex items-center gap-2">
                            ...
                            {/* Trash — only visible in edit mode */}
                            <AnimatePresence>
                                {isEditing && (
                                    <motion.button
                                        key="trash-btn"
