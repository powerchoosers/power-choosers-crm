...
export const metadata: Metadata = {
  ...
  title: 'Nodal Point | The Intelligence Platform for Energy',
  description: 'The first and only high-fidelity prospecting and forensic intelligence platform built specifically for commercial energy consultants.',
  icons: {
  ...
  openGraph: {
    ...
    title: 'Nodal Point | The Intelligence Platform for Energy',
    description: 'High-fidelity prospecting and forensic intelligence for commercial energy brokers. Identify cost leakage and automate outreach with precision.',
    url: BASE_URL,
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Nodal Point — The Intelligence Platform for Energy',
      },
    ],
  },
  twitter: {
    ...
    title: 'Nodal Point | The Intelligence Platform for Energy',
    description: 'High-fidelity prospecting and forensic intelligence for commercial energy brokers.',
