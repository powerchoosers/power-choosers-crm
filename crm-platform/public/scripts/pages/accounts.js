...
#accounts-page .table-scroll {
  ...
  function rowHtml(a) {
    ...
    const cells = {
      ...
      name: `<td class="name-cell"><a href="#account-details" class="acct-link" data-id="${aid}" title="View account details"><span class="company-cell__wrap">${getAccountIconHtml(a.logoUrl, favDomain)}<span class="name-text account-name">${escapeHtml(name || 'Unknown Account')}</span>${badges}</span></a></td>`,
