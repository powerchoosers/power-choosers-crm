...
#people-page .table-scroll {
  ...
  function rowHtml(c) {
    ...
    const cells = {
      ...
      company: `<td><a href="#account-details" class="company-link" data-company="${escapeHtml(company)}" data-domain="${escapeHtml(favDomain)}"><span class="company-cell__wrap">${getCompanyIconHtml(company, favDomain)}<span class="company-name">${escapeHtml(company)}</span></span></a></td>`,
