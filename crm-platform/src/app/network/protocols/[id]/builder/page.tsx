...
function ProtocolArchitectInner() {
  ...
  const { setSequenceIntelOpen, setActiveSequenceId } = useUIStore();
  ...
  useEffect(() => {
    ...
    return () => setActiveSequenceId(null);
  }, [id, setActiveSequenceId]);
      ...
      const response = await fetch('/api/ai/optimize', {
        ...
        body: JSON.stringify({
          ...
          contact: {
            ...
            intelligence_brief_confidence_level: testAccount?.intelligenceBriefConfidenceLevel || null,
            intelligence_brief_status: testAccount?.intelligenceBriefStatus || null,
