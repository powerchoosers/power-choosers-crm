            ...
            <div className="flex items-center gap-4">
              {isOutboundEmail ? (
                ...
                <CompanyIcon
                  ...
                  logoUrl={displayFromAddress?.toLowerCase() === 'signal@nodalpoint.io' ? '/images/nodalpoint-webicon.png' : undefined}
                  size={48}
                          ...
                          <div className="flex-shrink-0">
                            {threadIsOutbound ? (
                              ...
                              <CompanyIcon
                                ...
                                logoUrl={(parsedFrom.address || threadEmail.from || '').toLowerCase().includes('signal@nodalpoint.io') ? '/images/nodalpoint-webicon.png' : undefined}
                                size={40}
                                roundedClassName="rounded-[14px]"
                              />
                            )}
