...
async function handleGeneration(execution, job) {
  ...
  `
    ...
    const intelligenceBriefContext = buildIntelligenceBriefContext({
        signal_headline: member.intelligence_brief_headline || null,
        signal_detail: member.intelligence_brief_detail || null,
        talk_track: member.intelligence_brief_talk_track || null,
        signal_date: member.intelligence_brief_signal_date || null,
        source_url: member.intelligence_brief_source_url || null,
        confidence_level: member.intelligence_brief_confidence_level || null,
        last_refreshed_at: member.intelligence_brief_last_refreshed_at || null,
        status: member.intelligence_brief_status || null,
    });
    const researchFacts = [
