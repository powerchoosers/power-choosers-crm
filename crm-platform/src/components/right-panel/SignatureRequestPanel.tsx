    ...
    >
        ...
        <form id="sig-form" onSubmit={handleInitialSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              rows={4}
              className="w-full bg-black/30 border border-white/10 rounded-xl px-3 py-2 text-sm font-mono text-white focus:border-[#002FA7] focus:ring-1 focus:ring-[#002FA7]/50 outline-none transition-all resize-none"
            />
          </div>
        </form>
      </div>
      ...
      <div className="shrink-0 p-6 border-t border-white/5 bg-zinc-950/90">
        <button
          ...
          className="w-full h-10 bg-[#002FA7] hover:bg-[#002FA7]/90 text-white font-mono text-xs uppercase tracking-widest rounded-xl flex items-center justify-center gap-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
        >
