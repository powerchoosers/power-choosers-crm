...
export function RightPanel() {
  return (
    <aside className="fixed right-0 top-0 bottom-0 z-30 w-80 bg-zinc-950/50 backdrop-blur-xl border-l border-white/5 pt-24 pb-8 px-6 flex flex-col gap-8 overflow-y-auto hidden xl:flex">
