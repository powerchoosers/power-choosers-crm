...
const frozenSelectCellBase =
  "!sticky !left-0 z-30 transform-gpu box-border w-10 min-w-10 max-w-10 px-0 border-b-0 shadow-[inset_0_-1px_0_rgba(255,255,255,0.06)] transition-colors backdrop-blur-md supports-[backdrop-filter]:bg-zinc-950/65"
