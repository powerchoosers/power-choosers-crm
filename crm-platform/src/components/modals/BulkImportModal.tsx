...
const CONTACT_FIELDS: ImportFieldDefinition[] = [
  ...
  { id: 'company_linkedin', label: 'Company LinkedIn', required: false },
  { id: 'company_description', label: 'Company Description', required: false },
  { id: 'company_industry', label: 'Company Industry', required: false },
  ...
  { id: 'company_address', label: 'Company Address', required: false },
  { id: 'company_country', label: 'Company Country', required: false },
  { id: 'company_postal_code', label: 'Company Postal Code', required: false },
  { id: 'company_employee_count', label: 'Company Employee Count', required: false },
