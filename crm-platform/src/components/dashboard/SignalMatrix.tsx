                    ...
                    <div className="p-3 rounded-lg bg-white/[0.02] border border-white/5">
                      {selectedSignal.crm_account_id ? (
                        <div className="flex items-center gap-2 text-emerald-400">
                          ...
                          <span className="text-[10px] font-mono uppercase tracking-widest">Active_CRM_Record</span>
                        </div>
                      ) : (
                        <div className="flex items-center gap-2 text-[#4D88FF]">
                          <Radar className="w-3 h-3" />
                          <span className="text-[10px] font-mono uppercase tracking-widest">Unfiltered_Prospect</span>
                        </div>
                      )}
                    </div>
                  </section>
            ...
            <div className="mt-6 pt-6 border-t border-white/5 flex items-center justify-end gap-3">
              {selectedSignal.source_url && (
                <a
                  ...
                  className="flex items-center gap-2 px-4 py-2.5 rounded-lg bg-white/5 border border-white/5 text-[10px] font-mono text-zinc-400 hover:text-white hover:border-white/20 transition-all uppercase tracking-widest"
                >
