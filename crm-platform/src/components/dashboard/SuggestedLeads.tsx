        ...
        {leads.map((lead) => (
          ...
          >
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-2xl bg-zinc-900/80 flex items-center justify-center border border-white/5 text-zinc-400 group-hover/item:text-white group-hover/item:border-white/10 transition-all shadow-inner">
