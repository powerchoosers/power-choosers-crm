...
function inferIndustryCluster(account: AccountRow, candidate: ResearchHit | null): IndustryCluster {
  ...
  if (/(manufactur|industrial|fabricat|machine|plastics?|chemical|metal|steel|packag|production|component|construction|epc|builder|contractor|automotive|auto)/.test(text)) return 'manufacturing'
  ...
  if (/(retail|store|shopping|franchise|dealer|showroom|convenience|recreation|fitness|gym|entertainment|amusement)/.test(text)) return 'retail'
