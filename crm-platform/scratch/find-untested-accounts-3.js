...
const testedIds = [
  ...
  '2900702f-d6d7-42c8-bcae-46a0467759c2', // Cars and Credit Master
  'bf157428-4221-487e-8ff3-b59070e94a2e', // AOG Living
  '881fcc7f-5400-4b18-b8fd-3cd13c1da132', // Christ For The Nations
  '5317cdf7-cd9e-46b8-92fe-98d1169fb19c'  // 48forty Solutions
];
...
async function run() {
  ...
  console.log('\n=================== MORE UNTESTED ACCOUNTS ===================');
  data.forEach((acc, i) => {
    console.log(`${i+16}. Name: ${acc.name} | Industry: ${acc.industry} | Location: ${acc.city || 'N/A'}, ${acc.state || 'N/A'}`);
